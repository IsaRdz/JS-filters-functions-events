...
const aArrowFunctionImplicitReturn = () => "Hello World Arrow function Implicit";

const aArrowFunctionExplicitReturn = () => {
    return "Hello World Arrow function Explicit";
} 

const sumWithArrowFunctionImplicit = (num1, num2) => num1+num2;

const sumWithArrowFunctionExplicit = (num1, num2) => {
    return num1+num2;
}

console.log(aFunction());
console.log(aArrowFunctionImplicitReturn());
console.log(aArrowFunctionExplicitReturn());
console.log(sumWithArrowFunctionImplicit(2,5));
console.log(sumWithArrowFunctionExplicit(7,6));
